package com.me.flightticketapp;
...
import com.me.flightticketapp.adapter.TicketsAdapter;
import com.me.flightticketapp.api.ServiceGenerator;
import com.me.flightticketapp.api.TicketsService;
...
public class MainActivity extends AppCompatActivity implements TicketsAdapter.TicketsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ticketsService = ServiceGenerator.createService(TicketsService.class);
    ...
    private Observable<List<Ticket>> getTickets(String from, String to) {
        return ticketsService.searchTickets(from, to)
                .toObservable()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread());
    }
