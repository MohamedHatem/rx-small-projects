...
import com.me.notessaver.api.NotesService;
import com.me.notessaver.api.ServiceGenerator;
import com.me.notessaver.model.Note;
import com.me.notessaver.model.User;
import com.me.notessaver.utils.MyDividerItemDecoration;
import com.me.notessaver.utils.PrefrencesHelper;
import com.me.notessaver.utils.RecyclerTouchListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notesService = ServiceGenerator.createService(NotesService.class, getApplicationContext());
         ...
         * */
        if (TextUtils.isEmpty(PrefrencesHelper.getApiKey(this))) {
            registerUser();
        } else {
                ...
                notesService
                        ...
                        .subscribeWith(new DisposableSingleObserver<User>() {
                            ...
                            public void onSuccess(User user) {
                                ...
                                PrefrencesHelper.storeApiKey(getApplicationContext(), user.getApiKey());

                                Toast.makeText(getApplicationContext(),
                                        "Device is registered successfully! ApiKey: " + PrefrencesHelper.getApiKey(getApplicationContext()),
